...
public class UserController {
    ...
    @PostMapping(value = "/updatePassword", params = {"password", "code"})
    ...
    @GetMapping(value = "/getFriend", params = {"type", "page", "size"})
